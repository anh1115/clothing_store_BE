...
class OrderLineSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = OrderLine
        fields = ['orderline_id', 'product_name', 'product_sell_price', 'color_name', 'size_name','quantity', 'subtotal']
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ['order_id', 'user', 'status', 'total_price', 'payment_method','note', 'created_at', 'updated_at', 'order_lines']
