...
class OrderLine(models.Model):
    ...
    color = models.ForeignKey('products.Color', on_delete=models.CASCADE, related_name='order_lines')  
    size = models.ForeignKey('products.Size', on_delete=models.CASCADE, related_name='order_lines') 
